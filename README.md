...
프론트엔드 개발자로서, 단순히 동작하는 기능을 만드는 것을 넘어  
**사용자 경험(UX)을 고려한 성능 최적화**가 얼마나 중요한지 깨닫는 계기가 되었다.  
특히 에디터 자동 저장 기능을 구현하면서, Debounce 기법을 통해 서버 부하를 줄이고 더 나은 사용자 경험을 제공하는 방법을 직접 체득할 수 있었다.
